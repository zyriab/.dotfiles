...
local function toggleHeavenlySwitcharoo()
    local res = vim.api.nvim_exec2(":map ^", { output = true })

    local is_switched = res.output ~= nil and res.output ~= "\nNo mapping found"
...
-- vim.keymap.set("n", "<leader>a", toggleHeavenlySwitcharoo)
